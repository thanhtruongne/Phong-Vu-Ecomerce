                  ...
                  {{-- Tìm kiếm --}}
                   <div class="col-md-8 form-inline">
                      <form action="" class="form-inline w-100 form-search mb-3" id="form-search">
                           <input type="text" name="search" class="form-control w-30 mr-1" placeholder="-- Tên/Từ khóa widget --">
                   ...
                   <div class="col-md-4 text-right ">
                         <div class="">
                            <div class="btn_group">
                                ...
                                <a  href="{{route('private-system.widget.create')}}" class="btn">
                    ...
                    <thead>
                        <tr>    
                          <th data-field="index" data-align="center" data-width="5%" data-formatter="index_formatter">#</th> 
                            ...
                            <th data-field="image" data-formatter="image_formatted">Hình ảnh</th>
                            <th data-field="short_code" >Mã</th>
                            <th data-field="name" data-formatter="name_formatter" data-width="20%">Tên widget</th>
...
@section('scripts')
    <script>
        ...
        function image_formatted(value,row,index){
            return '<img src="'+value+'" width="400" height="100" class=""/>';
        }
        ...
        var table = new LoadBootstrapTable({
            ...
            url: '{{route('private-system.widget.getData')}}',
            remove_url: '{{route('private-system.widget.remove')}}',
        });
        ...
        function deleteRow(id){
          ...
          Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: 'POST',
                        url: '{{route('private-system.widget.remove')}}',
                        dataType: 'json',
                        data : {
                        'id' : id
                        }
         ...
         function changeStatus(status,type) {
            ...
            $.ajax({
                url: '{{route('private-system.widget.change_status')}}',
                type: 'post',
                data: {
                    ids: ids,
                    status: status
