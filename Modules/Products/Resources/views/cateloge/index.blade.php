...
@section('scripts')
    ...
    <script>
        ...
        var table = new LoadBootstrapTable({
            ...
            url: '{{ route('private-system.product-cateloge.getdata') }}',
            remove_url: '{{ route('private-system.product-cateloge.remove',['type' => "all"]) }}'
        });
        ...
        function deleteRow(id){
          Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: 'POST',
                        url: '{{route('private-system.product-cateloge.remove')}}',
                        dataType: 'json',
                        data : {
                        'id' : id
                        }
        ...
        function change_single_status(id){
            ...
            $.ajax({
                url: '{{route('private-system.product-cateloge.change.status')}}',
                type: 'post',
                data: {
                    id: id,
                    status: status
