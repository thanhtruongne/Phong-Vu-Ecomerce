    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <div>
                     <form action="{{route('private-system.management.{view}.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                                          ...
                                          <div class="">
                                              <select class="form-control select2" name="post_cateloges_id">
                                                  ...
                                                  @foreach ($categories as $category)
                                                      <option {{ old('post_cateloges_id') == $category->id ? 'selected' : '' }}  value="{{ $category->post_cataloge->id }}">
