...
class ProductController extends Controller
{
    ...
    {  
        ...
        return view('backend.Page.product.product.index',compact('trashedCount','config','filter','title','product'));
    }
    ...
    {
        $product = $this->productRepositories->getProductById($id ,$this->languageRepositories->getCurrentLanguage()->id);
        $categories = $this->postCatelogeRepositories->getAllCategories();
        $attributeCateloge = $this->attributeCatelogeRepositories->AllCateloge();
    ...
    public function restore(int $id) {
        if($this->productService->restore($id) == true) {
            toastr()->success('Khôi phục thành công','Thông báo');
            return redirect()->route('private-system.management.product.trashed');
        }
    ...
    public function deleteForce(int $id) {
        if($this->productService->deleteForce($id) == true) {
