...
class AttributeController extends Controller
{
    ...
    {  
        $trashedCount = $this->attributeRepositories->trashed()->count();
        ...
        return view('backend.Page.attribute.attribute.index',compact('trashedCount','config','filter','title','attribute','categories'));
    }
    ...
    public function restore(int $id) {
        if($this->attributeService->restore($id) == true) {
            toastr()->success('Khôi phục thành công','Thông báo');
            return redirect()->route('private-system.management.attribute.trashed');
        }
    ...
    public function deleteForce(int $id) {
        if($this->attributeService->deleteForce($id) == true) {
