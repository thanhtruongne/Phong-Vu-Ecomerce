...
class PostController extends Controller
{
    ...
    public function trashed() {
        $trashedCount = $this->postRepositories->trashed();
    ...
    public function restore(int $id) {
        if($this->postService->restore($id) == true) {
            toastr()->success('Khôi phục thành công','Thông báo');
            return redirect()->route('private-system.management.post.trashed');
        }
    ...
    public function deleteForce(int $id) {
        if($this->postService->deleteForce($id) == true) {
