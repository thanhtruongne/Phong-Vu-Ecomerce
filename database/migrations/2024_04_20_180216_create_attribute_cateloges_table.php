...
return new class extends Migration
{
    ...
    {
        Schema::create('attribute_cateloge_translate', function (Blueprint $table) {
    $table->unsignedBigInteger('attribute_cateloge_id')->nullable();
    ...
    {
        Schema::dropIfExists('attribute_cateloge_translate');
    }
};