<header>
    <div class="headear_widget">
        ...
        <div class="promotion_media_header" style="position:relative;z-index:999999">
        ...
        <div class="navigation_header">
          <div class="container css_navigation">
               <div class="teko-row-middle">
                    ...
                    <div class="col_row_navigation col_test_css">
                        <div class="button css-12qbrtd" data-content-region-name="headerBar" data-track-content="true" data-content-name="loginIcon">
                    ...
                    <div class="col_row_navigation col_test_css">
                        <div class="position-relative">
                            <div class="css-en0qru" tabindex="0">
                                <a target="_self" class="css-cbrxda" style="text-decoration: none;">
                                    <div class="css-hkiax3">
                                        ...
                                        <div class="ml-6 text-left">
                                            ...
                                            <div type="body" color="textSecondary" class="title css-1ajy8lg">(0) sản phẩm</div>
                                        </div>
                                    </div>
                                </a>
