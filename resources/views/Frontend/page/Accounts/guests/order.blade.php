...
@section('content')
@php
    $extract = explode('_',Cookie::get('guest_cookie'));
    $order = \App\Models\Order::where([['email','=',$extract[1]],['customer_id','=',null]])->get();
 @endphp
                        ...
                        <div class="d-flex flex-column">
                            <div class="d-flex">
                                ...
                                <div class="" style="margin-left: 0.5rem">
                                    ...
                                    <h5 style="font-size: 1rem;font-weight: bold;"> {{ $extract[1] }} </h5>
                                </div>
                            </div>
                            <ul style="padding: 0;margin: 0;list-style: none;">
                                <a href="{{ route('account.order') }}" style="text-decoration: none;color:#333333" class="css_hover">
