...
@php
    ...
    $userByOrder = \App\Models\Order::where('email',$extract[1])->first();
    $user = Auth::check() ? Auth::user()->toArray() : $userByOrder;
@endphp
    <div class="">
                    ...
                    <div class="d-flex flex-column">
                        <div class="d-flex">
                            ...
                            <div class="" style="margin-left: 0.5rem">
                                ...
                                <h5 style="font-size: 1rem;font-weight: bold;"> {{ $order->name }}</h5>
                            </div>
                        </div>
