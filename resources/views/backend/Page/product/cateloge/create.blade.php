    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title" style="min-height:60px">
                {{ Breadcrumbs::render('product.cateloge.create') }}           
                   
                
            </div>
            <div class="ibox-content">
                <div>
                     <form action="{{ route('private-system.management.product.cateloge.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
