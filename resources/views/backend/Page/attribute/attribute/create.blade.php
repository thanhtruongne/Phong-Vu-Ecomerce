...
@section('content')
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            {{ Breadcrumbs::render('attribute.create') }}           
                   
                
            </div>
            <div class="ibox-content">
                <div>
                     <form action="{{route('private-system.management.attribute.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                                          ...
                                          <div class="">
                                              <select class="form-control select2" name="attribute_cateloge_id">
                                                  ...
                                                  @foreach ($categories as $category)
                                                      <option {{ old('attribute_cateloge_id') == $category->id ? 'selected' : '' }}  value="{{ $category->id }}">
