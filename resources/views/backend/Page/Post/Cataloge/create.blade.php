    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title" style="min-height:60px">
                {{ Breadcrumbs::render('post-cataloge-create') }}           
                    <h5 style="margin-top: 6px">{{ $filter['create']['title'] }}</h5>
                
            </div>
            <form action="{{ route('private-system.management.post-cataloge.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="form-group" style="margin-top: 8px"><label class="control-label">Chọn danh mục cha (*)</label>
                                <div class="">
                                    <select class="form-control select2" name="categories_id">
                                        ...
                                        @foreach ($postCataloge as $category)
