<div class="ibox-content" style="margin-top:20px;height:500px">
    <div class="form-horizontal">
            ...
            <div style="margin: 12px 0px" class="SEO">
                 <h2 class="title_seo">{{ old('meta_title',($data->meta_title) ?? 'Báo Thanh Niên: Tin tức 24h mới nhất, tin nhanh, tin nóng ..') }}</h2>
                 <span class="link_seo">{{ old('meta_link',($data->meta_keyword) ?? 'http://localhost:8000/private') }} </span>
                 <p class="desc_seo">{{ old('meta_desc',($data->meta_desc) ?? 'Tin tức 24h, đọc báo TN cập nhật tin nóng online Việt Nam và thế giới mới nhất trong ngày, tin nhanh thời sự, chính trị, xã hội hôm nay, tin tức, top news ...') }}</p>
            </div>
            <div class="form-group" style="margin-top: 8px"><label class="col-sm-2 control-label">Tiêu đề SEO (*)</label>
                <div class="col-sm-10">
                    <input type="text" value="{{ old('meta_title',($data->meta_title) ?? '') }}" name="meta_title" class="form-control title_seo_link_meta">
                </div>
            ...
            <div class="form-group" style="margin-top: 8px"><label class="col-sm-2 control-label">Từ khóa SEO (*)</label>
                 <div class="col-sm-10">
                     <input type="text" value="{{ old('meta_keyword',($data->meta_keyword) ?? '') }}" name="meta_keyword" class="form-control">
                 </div>
             ...
             <div class="form-group" style="margin-top: 8px"><label class="col-sm-2 control-label">Mô tả SEO (*)</label>
                 <div class="col-sm-10">
                     <textarea value="{{ old('meta_desc') }}" name="meta_desc" class="form-control desc_seo_title">{{ old('meta_desc',($data->meta_desc) ?? '') }}</textarea>
                 </div>
