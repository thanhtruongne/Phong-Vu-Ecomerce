...
// Route trả về view React cho tất cả các tuyến đường giao diện
//get data from react
// Route::get('/get-data-layout', [HomeController::class, 'getDataLayout'])->name('home');
//get curren user
// Route::get('/user/getCurrenUser', function () {
