...
use App\Http\Controllers\Backend\Ajax\CartController as AjaxCartController;
...
use App\Http\Controllers\Backend\Post\PostCatalogeController;
use App\Http\Controllers\Backend\Post\PostController;
use App\Http\Controllers\Backend\User\UserCatalogeController;
use App\Http\Controllers\Backend\User\UserController;
use Illuminate\Support\Facades\Route;
use App\Http\Controllers\Backend\OrderController;
use App\Http\Controllers\Backend\Products\ProductCatelogeController;
use App\Http\Controllers\Backend\Products\ProductController;
use App\Http\Controllers\Backend\Products\AttributeCatelogeController;
use App\Http\Controllers\Backend\Products\AttributeController;

use App\Http\Controllers\Backend\Menu\MenuCatelogeController;
use App\Http\Controllers\Backend\Menu\MenuController;
use App\Http\Controllers\Backend\Promotions\PromotionController;
...
//admin login
    ...
    Route::get('/login',[AuthencateController::class,'login'])->name('login');
    Route::post('/post-login',[AuthencateController::class,'AdminStoreLogin'])->name('post.login');

    Route::middleware(['checkSanctum','auth:sanctum','checkGuard:admin'])->group(function(){
